...
<div class="container-fluid">
  <form method="POST" enctype="multipart/form-data" action="{{route('servicio.store')}}" autocomplete="off" class="needs-validation" novalidate>
    @method('POST')
    @csrf
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" id="precio" name="precio" type="text" pattern=".*\S+.*" placeholder="ingrese su precio"value="{{old('precio')}}" required />
